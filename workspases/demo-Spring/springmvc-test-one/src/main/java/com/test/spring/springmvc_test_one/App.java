...
/**
 * Hello world!
 *加上@SessionAttributes sessionScope才能取到值
 */
@Controller
...
public class App {
	...
	/**
	 * headers = { "Accept-Language=zh-CN,zh;q=0.8"} 报错404
	 * 
	 * @return
	 */
	@RequestMapping(value = "/testParamsAndHeaders", params = { "username", "age" }, method = RequestMethod.GET)
